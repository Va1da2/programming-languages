# Programming Languages: Section 8 - A Longer Example
...
class MyRational
    ...
    # and a built-in syntactic sugar will work: can write r1 + r2
    def + r
...
private
    ...
    def reduce
        if @num == 0
            ...
            d = gcd(@num.abs, @den) # notice a method call on number
            @num = @num / d
            @den = @den / d
        end
    end
