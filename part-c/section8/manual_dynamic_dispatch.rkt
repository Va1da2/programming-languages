; Programming Languages: Section 8 -
...
;;  * an immutable list of mutable "fields" (symbols and content)
;;  * an immutable list of immutable "methods" (symbols and functions)
...
(define (send obj msg . args) ; convenience: multi-argument functions
...
(define (make-polar-point _r _th)
  (let ([pt (make-point #f #f)])
    (obj
     ...
     (append ; overriding by beying earlier in the list (see send function)
      (list
       (cons 'set-r-theta
             (lambda (self args)
               (begin
