...
(* helper function is overkill here but wil provide a more direct contrast
   with more complicated examples soon *)
fun add_values (v1, v2) =
    case (v1, v2) of
	(Int i, Int j) => Int (i + j)
      | _ => raise BadResult "non-ints in addition";

fun multiply_values (v1, v2) =
    case (v1, v2) of
	(Int i, Int j) => Int (i * j)
      | _ => raise BadResult "non-ints in multiplication";

fun eval e = (* no environment because no variable exps *)
    case e of
	Int _ => e
      ...
      | Mult(e1, e2) => multiply_values (eval e1, eval e2);
