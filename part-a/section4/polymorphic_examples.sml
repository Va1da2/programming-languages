(* Programming Languages: Section 4: Type Inference, polymorphic examples *)
...
(*
  ...
  from f being passed the sult of g, T1=T6->T7 for some T7
  from f being a body of anonymous function T7=T5
